...
export const PACKAGE_CATALOG: PackageEntry[] = [
  ...
  { id: "@3jse/vfx", capability: "CPU particle sim (SoA, seeded), size/color curves over life, ParticleEmitter component/system", phase: 5, status: "partial", points: ["components", "systems"], official: true },
