...
export const PACKAGE_CATALOG: PackageEntry[] = [
  ...
  { id: "@3jse/materials", capability: "Material Graph -> TSL codegen + CPU reference evaluator + validation + splat/water presets", phase: 5, status: "shipped", points: ["materialNodes", "editorPanels"], official: true },
  { id: "@3jse/terrain", capability: "Heightfield sampling / chunk mesher / LOD / bounded-residency streamer / splat maps + brush painting", phase: 5, status: "partial", points: ["components", "systems"], official: true },
  ...
  { id: "@3jse/llm", capability: "Provider-agnostic chat client (OpenAI/Anthropic/DeepSeek/Gemini/OpenRouter/Groq/Mistral/xAI/Ollama/any OpenAI-compatible) — the model behind Atlas 'Ask agent' + AI_AGENT_API PLAN", phase: 6, status: "shipped", points: [], official: true },
